...
def solve(function, tolerance='1/100000000', max_terms=16,
    ...
    allowed = {'source_modes', 'source_bits', 'basis_policy', 'candidate_budget', 'leading_cancellation'}
